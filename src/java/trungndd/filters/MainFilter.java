...
public class MainFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            if (role != null) { // if role is not null then just forward to resource
                myProperties = new MyProperties(role);
                session.setAttribute("RESOURCES", myProperties);

                // if resource doesn't available
                url = myProperties.getMyProperty(resource);
                if (url == null) {
            ...
            log("ERROR at MainFilter: " + e.getMessage());
        }
    }

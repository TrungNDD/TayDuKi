 ...
 * @author Admin
 */
public class UpdateLifeController extends HttpServlet {

    private static final String UPDATE = "viewLifePage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = myProperties.getMyProperty(UPDATE);

        try {
            String idLife = request.getParameter("id");
            ...
            if (LifeDAO.update(dto)) {
                request.setAttribute("SUCCESS", "Life updated Successfully");
            }
        } catch (Exception e) {
            log("ERROR at UpdateLifeController: " + e.getMessage());
            request.setAttribute("ERROR", "Update Life failed");
        } finally {

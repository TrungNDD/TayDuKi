 ...
 * @author Admin
 */
public class ViewEquipController extends HttpServlet {
    private static final String PROCCEED = "viewEquipPage";
    /** 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            EquipmentDTO dto = EquipmentDAO.getEquipById(idEquip);
            
            request.setAttribute("DTO", dto);
        } catch (Exception e) {
            log("ERROR at ViewEquipController: " + e.getMessage());
        } finally {

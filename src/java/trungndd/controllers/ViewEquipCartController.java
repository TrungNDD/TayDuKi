 ...
 * @author Admin
 */
public class ViewEquipCartController extends HttpServlet {

    private static final String PROCEED = "viewEquipCartPage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at ViewEquipCartController: " + e.getMessage());
        } finally {

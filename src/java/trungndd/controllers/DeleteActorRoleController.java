 ...
 * @author Admin
 */
public class DeleteActorRoleController extends HttpServlet {
    private static final String PROCEED = "viewActorRole";
    /** 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (ActorRoleDAO.delete(life.getIdLife(), idActor)) {
                request.setAttribute("MESSAGE", "Deleted" + idActor);
            } else {
                request.setAttribute("MESSAGE", "Failed to delete " + idActor);
            }
        } catch (Exception e) {
            log("ERROR at DeleteActorRoleController: " + e.getMessage());
        } finally {

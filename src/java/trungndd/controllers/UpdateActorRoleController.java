 ...
 * @author Admin
 */
public class UpdateActorRoleController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (ActorRoleDAO.update(dto)) {
                request.setAttribute("MESSAGE", "Updated " + idActor);
            } else {
                request.setAttribute("MESSAGE", "Failed to update " + idActor);
            }
        } catch (Exception e) {
            log("ERROR at UpdateActorRoleController: " + e.getMessage());
        } finally {
